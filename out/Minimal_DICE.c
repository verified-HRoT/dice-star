...
)
{
  switch (alg1)
  {
    case Spec_Hash_Definitions_SHA2_256:
      {
        return Hacl_Hash_SHA2_hash_256;
      }
    case Spec_Hash_Definitions_SHA2_384:
      {
        return Hacl_Hash_SHA2_hash_384;
      }
    case Spec_Hash_Definitions_SHA2_512:
      {
        return Hacl_Hash_SHA2_hash_512;
      }
    case Spec_Hash_Definitions_SHA1:
      {
        return Hacl_Hash_SHA1_legacy_hash;
      }
    default:
      {
...
)
{
  switch (alg1)
  {
    case Spec_Hash_Definitions_SHA2_256:
      {
        return Hacl_HMAC_compute_sha2_256;
      }
    case Spec_Hash_Definitions_SHA2_384:
      {
        return Hacl_HMAC_compute_sha2_384;
      }
    case Spec_Hash_Definitions_SHA2_512:
      {
        return Hacl_HMAC_compute_sha2_512;
      }
    case Spec_Hash_Definitions_SHA1:
      {
        return Hacl_HMAC_legacy_compute_sha1;
      }
    default:
      {
        KRML_HOST_EPRINTF("KreMLin incomplete match at %s:%d\n", __FILE__, __LINE__);
