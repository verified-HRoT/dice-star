...
extern void Hacl_Hash_Core_SHA1_legacy_init(Lib_IntTypes_sec_int_t____ *uu____70);
...
extern void Hacl_Hash_Core_SHA1_legacy_pad(uint64_t uu____191, Lib_IntTypes_sec_int_t____ *x0);
