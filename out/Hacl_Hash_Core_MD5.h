...
extern void Hacl_Hash_Core_MD5_legacy_init(Lib_IntTypes_sec_int_t____ *uu____70);

extern void
Hacl_Hash_Core_MD5_legacy_update(
  Lib_IntTypes_sec_int_t____ *uu____126,
  Lib_IntTypes_sec_int_t____ *x0
);

extern void Hacl_Hash_Core_MD5_legacy_pad(uint64_t uu____191, Lib_IntTypes_sec_int_t____ *x0);

extern void
Hacl_Hash_Core_MD5_legacy_finish(
  Lib_IntTypes_sec_int_t____ *uu____250,
  Lib_IntTypes_sec_int_t____ *x0
);
