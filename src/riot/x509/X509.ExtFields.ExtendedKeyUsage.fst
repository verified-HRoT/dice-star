...
= let oids', oid = List.Tot.Base.unsnoc oids in
  ...
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            serialize_x509_keyPurposeIDs_unfold_spec oids' (fst x)
            `Seq.append`
...
let rec lemma_serialize_x509_keyPurposeIDs_unfold
  ...
  (x: x509_keyPurposeIDs_t oids)
: Lemma (ensures
  serialize (serialize_x509_keyPurposeIDs oids) x ==
  serialize_x509_keyPurposeIDs_unfold_spec oids x
)
  (decreases (List.length oids))
= let oids', oid = List.Tot.Base.unsnoc oids in
  List.Tot.Properties.lemma_unsnoc_length oids;
  ...
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            ...
            (* in *) x;
            lemma_serialize_x509_keyPurposeIDs_unfold oids' (fst x) )

(*
 * Reveals the structure and size of all oids
 * Use with `lemma_serialize_x509_keyPurposeIDs_size_norm` (defined later)
 *)
...
= lemma_serialize_x509_keyPurposeIDs_unfold oids x;
  ...
  List.Tot.Properties.lemma_unsnoc_length oids;
  match oids' with
  | [] -> ( length_of_opaque_serialization (serialize_asn1_oid_TLV_of x) x ==
            length_of_TLV OID (length_of_oid x) )
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            length_of_opaque_serialization (serialize_asn1_oid_TLV_of (snd x)) (snd x) ==
            length_of_TLV OID (length_of_oid (snd x)) /\
            predicate_serialize_x509_keyPurposeIDs_size_oids oids' (fst x) )
...
= let oids', oid = List.Tot.Base.unsnoc oids in
  List.Tot.Properties.lemma_unsnoc_length oids;
  match oids' with
  | [] -> ( length_of_opaque_serialization (serialize_asn1_oid_TLV_of oid) x )
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            serialize_x509_keyPurposeIDs_size_spec oids' (fst x) +
            length_of_opaque_serialization (serialize_asn1_oid_TLV_of (snd x)) (snd x) )
...
let rec lemma_serialize_x509_keyPurposeIDs_size
  ...
  (x: x509_keyPurposeIDs_t oids)
: Lemma (ensures
  length_of_opaque_serialization (serialize_x509_keyPurposeIDs oids) x ==
  serialize_x509_keyPurposeIDs_size_spec oids x /\
  predicate_serialize_x509_keyPurposeIDs_size_oids oids x
)
  (decreases (List.length oids))
= lemma_serialize_x509_keyPurposeIDs_unfold oids x;
  let oids', oid = List.Tot.Base.unsnoc oids in
  List.Tot.Properties.lemma_unsnoc_length oids;
  match oids' with
  | [] -> ( lemma_serialize_asn1_oid_TLV_of_size x x )
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            lemma_serialize_asn1_oid_TLV_of_size (snd x) (snd x);
            lemma_serialize_x509_keyPurposeIDs_unfold oids' (fst x);
            lemma_serialize_x509_keyPurposeIDs_size oids' (fst x) )
...
: GTot (l: asn1_value_length_of_type SEQUENCE
           { l == serialize_x509_keyPurposeIDs_size_spec oids x })
  (decreases (List.length oids))
= let oids', oid = List.Tot.Base.unsnoc oids in
  List.Tot.Properties.lemma_unsnoc_length oids;
  lemma_serialize_x509_keyPurposeIDs_size oids x;
  match oids' with
  | [] -> ( length_of_asn1_primitive_TLV #OID x )
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            lemma_serialize_x509_keyPurposeIDs_size oids' (fst x);
...
: Tot (len: asn1_value_int32_of_type SEQUENCE
           { v len == serialize_x509_keyPurposeIDs_size_spec oids x })
  (decreases (List.length oids))
= let oids', oid = List.Tot.Base.unsnoc oids in
  List.Tot.Properties.lemma_unsnoc_length oids;
  lemma_serialize_x509_keyPurposeIDs_size oids x;
  match oids' with
  | [] -> ( len_of_asn1_primitive_TLV #OID x )
  | _  -> ( let x = x <: x509_keyPurposeIDs_t oids' `tuple2` get_parser_type (parse_asn1_oid_TLV_of oid) in
            lemma_serialize_x509_keyPurposeIDs_size oids' (fst x);
            len_of_x509_keyPurposeIDs oids' (fst x) +
...
let serialize32_x509_ext_key_usage_payload_backwards
  (oids: list (datatype_of_asn1_type OID) {valid_keyPurposeIDs oids})
  (s32: serializer32_backwards (serialize_x509_keyPurposeIDs oids))
...
let length_of_x509_ext_key_usage_payload_unbound
  (oids: list (datatype_of_asn1_type OID) {valid_keyPurposeIDs oids})
  (x: x509_keyPurposeIDs_t oids
      { serialize_x509_keyPurposeIDs_size_spec oids x
        <= asn1_value_length_max_of_type SEQUENCE })
...
= length_of_TLV
    (SEQUENCE)
    (length_of_x509_keyPurposeIDs oids x)
...
let length_of_x509_ext_key_usage_payload
  ...
  (x: x509_keyPurposeIDs_t oids
      { serialize_x509_keyPurposeIDs_size_spec oids x
        <= asn1_value_length_max_of_type SEQUENCE /\
        length_of_x509_ext_key_usage_payload_unbound oids x
...
: Tot (len: asn1_value_int32_of_type OCTET_STRING
            { v len == length_of_x509_ext_key_usage_payload oids x })
= len_of_TLV
    (SEQUENCE)
    (len_of_x509_keyPurposeIDs oids x)
...
let lemma_serialize_x509_ext_key_usage_payload_size_exact
  ...
  (x: x509_ext_key_usage_payload_t oids
      { serialize_x509_keyPurposeIDs_size_spec oids x
        ...
        <= asn1_value_length_max_of_type OCTET_STRING })
: Lemma (
  length_of_opaque_serialization (serialize_x509_ext_key_usage_payload oids) x ==
  length_of_x509_ext_key_usage_payload oids x
)
= lemma_serialize_x509_ext_key_usage_payload_unfold oids x;
  lemma_serialize_x509_ext_key_usage_payload_size oids x;
    lemma_serialize_x509_keyPurposeIDs_size oids x
...
= coerce_serializer32_backwards
    ...
    (**) (OID_EXTENDED_KEY_USAGE)
    (**) (serialize32_x509_ext_key_usage_payload_backwards oids s32))
    ()
...
let length_of_x509_ext_key_usage
  ...
  (x: x509_keyPurposeIDs_t oids
      { serialize_x509_keyPurposeIDs_size_spec oids x
        ...
        length_of_x509_ext_key_usage_payload_unbound oids x
        <= asn1_value_length_max_of_type OCTET_STRING /\
       (let _ = lemma_serialize_x509_keyPurposeIDs_size oids x;
                lemma_serialize_x509_ext_key_usage_payload_size_exact oids x in
...
: GTot (asn1_TLV_length_of_type SEQUENCE)
= lemma_serialize_x509_keyPurposeIDs_size oids x;
  lemma_serialize_x509_ext_key_usage_payload_size_exact oids x;
...
: Tot (len: asn1_TLV_int32_of_type SEQUENCE
            { v len == length_of_x509_ext_key_usage oids x })
= lemma_serialize_x509_keyPurposeIDs_size oids x;
  lemma_serialize_x509_ext_key_usage_payload_size_exact oids x;
  len_of_x509_extension
    ...
    (serialize_x509_ext_key_usage_payload oids)
    (x <: x509_ext_key_usage_payload_t oids)
    (len_of_x509_ext_key_usage_payload oids x)

let lemma_serialize_x509_ext_key_usage_size_exact
  (oids: list (datatype_of_asn1_type OID) {valid_keyPurposeIDs oids})
  (x: x509_ext_key_usage_t oids
      { serialize_x509_keyPurposeIDs_size_spec oids (snd x)
        <= asn1_value_length_max_of_type SEQUENCE /\
        length_of_x509_ext_key_usage_payload_unbound oids (snd x)
        <= asn1_value_length_max_of_type OCTET_STRING /\
       (let _ = lemma_serialize_x509_keyPurposeIDs_size oids (snd x);
                lemma_serialize_x509_ext_key_usage_payload_size_exact oids (snd x) in
        length_of_x509_extension_payload_unbounded
          (OID_EXTENDED_KEY_USAGE)
          (serialize_x509_ext_key_usage_payload oids)
          ((snd x) <: x509_ext_key_usage_payload_t oids)
          (length_of_x509_ext_key_usage_payload oids (snd x))
        <= asn1_value_length_max_of_type (SEQUENCE)) })
: Lemma (
  length_of_opaque_serialization (serialize_x509_ext_key_usage oids) x ==
  length_of_x509_ext_key_usage oids (snd x)
)
= lemma_serialize_x509_ext_key_usage_payload_size_exact oids (snd x);
  lemma_serialize_x509_keyPurposeIDs_size oids (snd x);
...
let x509_get_ext_extendedKeyUsage
  ...
  (criticality: datatype_of_asn1_type BOOLEAN
                { let kpIDs: x509_keyPurposeIDs_t oids = get_x509_keyPurposeIDs oids in
                  ...
                  <= asn1_value_length_max_of_type SEQUENCE /\
                  length_of_x509_ext_key_usage_payload_unbound oids kpIDs
                  <= asn1_value_length_max_of_type OCTET_STRING /\
...
=
  let kpIDs: x509_keyPurposeIDs_t oids = get_x509_keyPurposeIDs oids in
  lemma_serialize_x509_keyPurposeIDs_size oids kpIDs;

  let ext_payload: x509_ext_key_usage_payload_t oids = get_x509_keyPurposeIDs oids in
  lemma_serialize_x509_ext_key_usage_payload_size_exact oids ext_payload;

  let ext: x509_ext_key_usage_t oids = x509_get_extension
                                         (OID_EXTENDED_KEY_USAGE)
                                         (serialize_x509_ext_key_usage_payload oids)
                                         (ext_payload)
                                         (len_of_x509_ext_key_usage_payload oids ext_payload)
                                         (criticality)
                                         in
