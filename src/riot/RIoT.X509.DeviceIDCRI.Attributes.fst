...
let deviceIDCRI_attributes_extensionRequest_t
...
let serialize_deviceIDCRI_attributes_extensionRequest
// : serializer (parse_deviceIDCRI_attributes_extensionRequest)
= coerce_parser_serializer
  (* p *) (parse_deviceIDCRI_attributes_extensionRequest)
...
let lemma_serialize_deviceIDCRI_attributes_extensionRequest_unfold
  (x: deviceIDCRI_attributes_extensionRequest_t)
...
let lemma_serialize_deviceIDCRI_attributes_extensionRequest_size
  (x: deviceIDCRI_attributes_extensionRequest_t)
...
let lemma_serialize_deviceIDCRI_attributes_extensionRequest_size_exact
  (x: deviceIDCRI_attributes_extensionRequest_t)
: Lemma (
  let x' = coerce_envelop
             ...
             (**) (SET `serialize_asn1_envelop_tag_with_TLV`
                  (**) (SEQUENCE `serialize_asn1_envelop_tag_with_TLV`
                       (**) serialize_deviceIDCRI_attributes_extensionRequest_payload)))
             (x) in
  length_of_opaque_serialization serialize_deviceIDCRI_attributes_extensionRequest x
  == length_of_deviceIDCRI_attributes_extensionRequest (snd (snd x').deviceID_attr_ext_key_usage)
)
= (* reveal top level *)
  lemma_serialize_deviceIDCRI_attributes_extensionRequest_size x;
...
let serialize32_deviceIDCRI_attributes_extensionRequest_backwards
...
= coerce_serializer32_backwards
  ...
  (* s32 *) ((CUSTOM_TAG CONTEXT_SPECIFIC CONSTRUCTED 0uy `asn1_implicit_tagging` SET) `serialize32_asn1_envelop_tag_with_TLV_backwards`
            (**) (SEQUENCE `serialize32_asn1_envelop_tag_with_TLV_backwards`
                 (**) (OID_AT_CN `serialize32_envelop_OID_with_backwards`
...
let x509_get_deviceIDCRI_attributes
  (ku: key_usage_payload_t)
: Tot (deviceIDCRI_attributes_extensionRequest_t)
=
  ...
  (* attach the OID *)
  let attrs: (OID_AT_CN `envelop_OID_with_t`
  ...
  (* Prf *) lemma_serialize_asn1_oid_TLV_of_size OID_AT_CN OID_AT_CN;
