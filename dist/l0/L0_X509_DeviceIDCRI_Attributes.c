...
)
{
  ...
  offset21 =
    serialize32_asn1_length_of_type_backwards(((asn1_tag_t){ .tag = SET }),
      ...
      b,
      pos - offset_data0);
  b[pos - offset_data0 - offset21 - 1U] = encode_asn1_tag(((asn1_tag_t){ .tag = SET }));
  ...
  offset23 =
    serialize32_asn1_length_of_type_backwards(((asn1_tag_t){ .tag = SEQUENCE }),
      ...
      b,
      pos - offset_data1);
  b[pos - offset_data1 - offset23 - 1U] = encode_asn1_tag(((asn1_tag_t){ .tag = SEQUENCE }));
  uint32_t offset13 = 1U;
