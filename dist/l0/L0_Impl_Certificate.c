...
{
  FStar_Bytes_bytes fwid_pub32 = FStar_Bytes_of_buffer(32U, (uint8_t *)fwid);
  FStar_Bytes_bytes deviceID_pub32 = FStar_Bytes_of_buffer(32U, (uint8_t *)deviceID_pub);
  FStar_Bytes_bytes aliasKey_pub32 = FStar_Bytes_of_buffer(32U, (uint8_t *)aliasKey_pub);
  FStar_Bytes_bytes keyID_pub32 = FStar_Bytes_of_buffer(20U, (uint8_t *)keyID);
  aliasKeyTBS_bytes
  b =
    {
  ...
  octet_string_t keyID_string = { .len = 20U, .s = b.keyID_pub32 };
  ...
  serialize32_aliasKeyTBS_backwards(aliasKeyTBS, (uint8_t *)aliasKeyTBS_buf, aliasKeyTBS_len);
}
...
)
{
  ...
  memset(aliasKeyTBS_sig_sec, 0U, 64U * sizeof (uint8_t));
  Hacl_Ed25519_sign(aliasKeyTBS_sig_sec, deviceID_priv, aliasKeyTBS_len, aliasKeyTBS_buf_sec);
  uint8_t aliasKeyTBS_sig[64U];
  memset(aliasKeyTBS_sig, 0U, 64U * sizeof (uint8_t));
  declassify_secret_buffer(64U, aliasKeyTBS_sig_sec, aliasKeyTBS_sig);
  FStar_Bytes_bytes
  aliasKeyTBS_buf32 = FStar_Bytes_of_buffer(aliasKeyTBS_len, (uint8_t *)aliasKeyTBS_buf);
  FStar_Bytes_bytes aliasKeyTBS_sig32 = FStar_Bytes_of_buffer(64U, (uint8_t *)aliasKeyTBS_sig);
...
)
{
  ...
  LowStar_Printf_print_string("Serializing AliasKey Certificate TBS\n");
  serialize32_deviceIDCRI_backwards(deviceIDCRI, (uint8_t *)deviceIDCRI_buf, deviceIDCRI_len);
}
...
)
{
  ...
  memset(deviceIDCRI_sig_sec, 0U, 64U * sizeof (uint8_t));
  Hacl_Ed25519_sign(deviceIDCRI_sig_sec, deviceID_priv, deviceIDCRI_len, deviceIDCRI_buf_sec);
  uint8_t deviceIDCRI_sig[64U];
  memset(deviceIDCRI_sig, 0U, 64U * sizeof (uint8_t));
  declassify_secret_buffer(64U, deviceIDCRI_sig_sec, deviceIDCRI_sig);
  FStar_Bytes_bytes
  deviceIDCRI_buf32 = FStar_Bytes_of_buffer(deviceIDCRI_len, (uint8_t *)deviceIDCRI_buf);
  FStar_Bytes_bytes deviceIDCRI_sig32 = FStar_Bytes_of_buffer(64U, (uint8_t *)deviceIDCRI_sig);
  LowStar_Printf_print_string("Creating AliasKey Certificate CRT message\n");
